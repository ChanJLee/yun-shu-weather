 ...
 */
public class FluHolder extends RecyclerView.ViewHolder implements IHolder {

    @Bind(R.id.id_suggestion)
    TextView m_suggestion;

    public FluHolder(View itemView) {
        super(itemView);
    ...
    public void bind(WeatherResponse response) {
        ...
        if(suggestionEntity != null) {
            m_suggestion.setText(suggestionEntity.getFlu().getTxt());
        }
    }
}
